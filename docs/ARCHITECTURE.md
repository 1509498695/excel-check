...
- 9 类规则：`not_null / unique / regex_check / sequence_order_check / fixed_value_compare / cross_table_mapping / composite_condition_check / dual_composite_compare / multi_composite_pipeline_check`。
...
```text
{
  ...
  "rules":     [{
    ...
    target_variable_tag,
    rule_type: "fixed_value_compare" | "regex_check" | "sequence_order_check" | "not_null" | "unique" | "cross_table_mapping" | "composite_condition_check" | "dual_composite_compare" | "multi_composite_pipeline_check",
